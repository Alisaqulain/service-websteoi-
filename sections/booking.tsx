...
export function BookingSection() {
  ...
  return (
    <section id="book" className="bg-white" aria-label="Book your advisory">
      <div className="bg-primary py-12 text-white md:py-14">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center gap-2">
            <ShieldCheck className="size-6" />
            <h2 className="text-xl font-bold md:text-2xl">Secure Payment Gateway</h2>
          </div>

          <div className="relative mx-auto mt-10 grid max-w-4xl gap-10 md:grid-cols-2 md:gap-16">
            <div className="flex flex-col items-center">
              <span className="rounded-lg bg-black px-4 py-1.5 text-sm font-medium text-white">
                Scan & Pay
              </span>
              <div className="mt-5 flex size-48 items-center justify-center rounded-xl bg-white p-4 md:size-56">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="mt-5 w-full max-w-xs rounded-xl bg-white p-6">
                <div className="grid grid-cols-2 gap-4 text-center text-sm font-semibold text-black">
      ...
      <div className="container mx-auto px-4 py-14 sm:px-6 md:py-20 lg:px-8">
        <ScrollReveal direction="right" className="mx-auto max-w-6xl">
          <h2 className="text-center text-[clamp(1.75rem,3.5vw,2.25rem)] font-bold text-black">
